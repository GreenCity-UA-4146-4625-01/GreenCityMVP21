...
public class CustomShoppingListMapperTest {
    ...
    void convertSuccess() {
        ...
        assertEquals(expectedCustomShoppingListItem.getStatus(), customShoppingListMapper.convert(customShoppingListItemResponseDto).getStatus());
        assertEquals(expectedCustomShoppingListItem.getText(), customShoppingListMapper.convert(customShoppingListItemResponseDto).getText());
        assertEquals(expectedCustomShoppingListItem.getId(), customShoppingListMapper.convert(customShoppingListItemResponseDto).getId());
    }
