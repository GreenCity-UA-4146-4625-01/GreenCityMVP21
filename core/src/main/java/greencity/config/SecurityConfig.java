...
import greencity.security.oauth.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtTool jwtTool, UserService userService,
                          AuthenticationConfiguration authenticationConfiguration, OAuth2AuthenticationSuccessHandler oAuth2SuccessHandler) {
