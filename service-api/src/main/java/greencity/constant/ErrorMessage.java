...
public final class ErrorMessage {
    ...
    public static final String ALREADY_SUBSCRIBED = "A subscription for this email already exists";
    public static final String NOT_FOUND_SUBSCRIPTION = "Subscription for this email address not found";
