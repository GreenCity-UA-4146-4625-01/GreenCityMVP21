...
class CustomShoppingListResponseDtoMapperTest {
    ...
    void convertSuccess() {
        ...
        assertEquals(expectedCustomShoppingListItemResponseDto,
            customShoppingListResponseDtoMapper.convert(customShoppingListItem));
        assertEquals(expectedCustomShoppingListItemResponseDto.getStatus(),
            customShoppingListResponseDtoMapper.convert(customShoppingListItem).getStatus());
        assertEquals(expectedCustomShoppingListItemResponseDto.getText(),
            customShoppingListResponseDtoMapper.convert(customShoppingListItem).getText());
        assertEquals(expectedCustomShoppingListItemResponseDto.getId(),
            customShoppingListResponseDtoMapper.convert(customShoppingListItem).getId());
    }
    ...
    void convertWithNullFields() {
        ...
        assertEquals(ShoppingListItemStatus.ACTIVE,
            customShoppingListResponseDtoMapper.convert(customShoppingListItem).getStatus());
    }
